 ...
 <nav>
  ...
  <section class="hero">
    <div class="hero-content">
      <h1>Kebutuhan Mendesak untuk Melindungi Anak-Anak di Tengah Konflik Myanmar yang Semakin Meningkat</h1>
      <p>Anak-anak menyuarakan krisis iklim. Apakah kita mendengarkan?</p>
      <a href="http://127.0.0.1:3000/Payment.html" class="cta">Donasi Sekarang</a>
    </div>
  </section>

  <!-- Main Content -->
  <div class="content">
    <img src="../foto/wanita-palestina-bersama-anaknya-di-dekat-rumahnya-yang-hancur-_200114213428-417.jpg" alt="Flash floods in Medan" class="content-image">

    <h2>Gambaran Kampanye</h2>
    <p>Krisis yang memburuk di Myanmar telah menempatkan anak-anak dalam risiko besar. Kekerasan yang meningkat telah menghancurkan komunitas mereka, dengan banyak keluarga terpaksa mengungsi ke tempat yang tidak memadai.</p>

    <h3>menggalang dana untuk memberikan dukungan yang mendesak, termasuk:</h3>
    <ul>
      <li>Pendirian tempat penampungan yang aman.</li>
