<footer class="footer">
  <div class="container">
    <div class="footer-content">
      <div class="footer-section">
        ...
        <p>
          ...
          <a href="tel:+622154345850">(021) 54422442</a><br>
          <a href="tel:+6282144444444">+62 821-444-4444</a>
        </p>
        <h4>Ikuti Kami</h4>
      ...
      <div class="footer-section">
        <h4>Terhubung</h4>
        <ul>
          <li><a href="#">Cerita Kebaikan</a></li>
    ...
    <div class="footer-bottom">
      <p>Copyright © 2024 PT. DonGiv.com</p>
    </div>
  </div>
</footer>
