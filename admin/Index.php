      ...
      <div id="main-content" class="flex-1 p-6 ml-64">
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 mb-6">
          <div class="bg-white p-4 rounded-md shadow-md text-center">
            ...
            <p class="text-2xl text-blue-700 font-bold">Rp 1.200.000</p>
          </div>
          <div class="bg-white p-4 rounded-md shadow-md text-center">
            <h3 class="text-lg font-bold mb-2">Jumlah Kampanye</h3>
            <p class="text-2xl text-blue-700 font-bold">12</p>
          </div>
          <div class="bg-white p-4 rounded-md shadow-md text-center">
          ...
          <div class="bg-white p-4 rounded-md shadow-md text-center">
            <h3 class="text-lg font-bold mb-2">Distribusi Donasi</h3>
            <p class="text-2xl text-blue-700 font-bold">Rp 900.000</p>
          </div>
        </div>
          ...
          <table class="w-full text-left">
            <thead>
              <tr>
                ...
                <th class="py-2">Jenis Donasi</th>
              </tr>
            </thead>
            <tbody>
              <tr>
                <td class="py-2">Agustus</td>
                <td class="py-2">Rp 1.000.000</td>
                <td class="py-2">50</td>
                <td class="py-2">Uang Tunai</td>
              </tr>
              <tr>
                <td class="py-2">September</td>
                <td class="py-2">Rp 1.500.000</td>
                <td class="py-2">75</td>
                <td class="py-2">Transfer Bank</td>
              </tr>
              <tr>
                <td class="py-2">Oktober</td>
                <td class="py-2">Rp 2.000.000</td>
                <td class="py-2">100</td>
                <td class="py-2">Kartu Kredit</td>
              </tr>
            </tbody>
          </table>
        </div>
          ...
          document.addEventListener("DOMContentLoaded", function () {
            ...
            new Chart(perbandinganDonasiCtx, {
              ...
              options: {
                legend: {
                  labels: [
                    { text: "Donasi Merah Muda", fillStyle: "#FF69B4" },
                    { text: "Donasi Hijau", fillStyle: "#32CD32" },
                    { text: "Donasi Biru", fillStyle: "#6495ED" },
                    { text: "Donasi Oranye", fillStyle: "#FFA07A" },
                    { text: "Donasi Coklat", fillStyle: "#8B9467" },
                  ],
                },
              },
            });
