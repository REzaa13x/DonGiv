...
// Jika request AJAX pencarian berdasarkan penanggung_jawab
if (isset($_GET['ajax']) && $_GET['ajax'] === '1') {
  $keyword = $_GET['keyword'] ?? '';
  $keyword = mysqli_real_escape_string($conn, $keyword); // cegah SQL injection
...
// Query default untuk tampilan awal (bukan AJAX)
$query = mysqli_query($conn, "SELECT pd.*, kd.nama_donasi
  FROM penyaluran_donasi pd
  JOIN kategori_donasi kd ON pd.id_donasi = kd.id_kategori");
